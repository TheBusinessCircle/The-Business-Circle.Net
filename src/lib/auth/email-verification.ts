...
function buildVerificationEmailText(firstName: string, verificationUrl: string, ttlHours: number) {
  return [
    ...
    "Please confirm your email address to complete your account setup and unlock your member access.",
    "",
...
function buildVerificationEmailHtml(firstName: string, verificationUrl: string, ttlHours: number) {
  return `
    <div style="font-family: Arial, sans-serif; color: #0a1024; line-height: 1.6;">
      <h1 style="margin-bottom: 16px;">Verify your email address</h1>
      <p>Hi ${firstName},</p>
      <p>
        Welcome to The Business Circle Network. Please confirm your email address to complete your
        account setup and unlock your full member access.
      </p>
      <p>
...
async function sendVerificationEmailMessage(input: {
  ...
  const html = buildVerificationEmailHtml(input.firstName, input.verificationUrl, input.ttlHours);
