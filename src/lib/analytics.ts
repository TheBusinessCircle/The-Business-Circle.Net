...
export const ANALYTICS_EVENTS = {
  ...
  launchCodeEntered: "launch_code_entered",
  launchCodeValidated: "launch_code_validated",
  launchCodeInvalid: "launch_code_invalid",
  launchCodeFull: "launch_code_full",
  launchCodeCheckoutStarted: "launch_code_checkout_started",
  launchCodeCheckoutCompleted: "launch_code_checkout_completed",
  launchCodeSubscriptionTrialing: "launch_code_subscription_trialing",
  launchCodeSubscriptionActive: "launch_code_subscription_active",
  reviewRequestPageViewed: "review_request_page_viewed",
  reviewTextCopied: "review_text_copied",
  reviewSubmitted: "review_submitted",
  googleReviewClicked: "google_review_clicked",
  registrationStarted: "registration_started",
  spinToConnectStarted: "spin_to_connect_started",
  spinToConnectCompleted: "spin_to_connect_completed",
  spinToConnectDialogOpened: "spin_to_connect_dialog_opened",
  spinToConnectSignupClicked: "spin_to_connect_signup_clicked",
  spinToConnectLoginClicked: "spin_to_connect_login_clicked",
  spinToConnectDialogClosed: "spin_to_connect_dialog_closed",
  circleCardOnboardingViewed: "circle_card_onboarding_viewed",
  circleCardFirstBuildStarted: "circle_card_first_build_started",
  circleCardIdentityCompleted: "circle_card_identity_completed",
  circleCardPurposeCompleted: "circle_card_purpose_completed",
  circleCardConnectionMethodCompleted: "circle_card_connection_method_completed",
  circleCardPreviewOpened: "circle_card_preview_opened",
  circleCardPublishReady: "circle_card_publish_ready",
  circleCardFirstPublished: "circle_card_first_published",
  circleCardOnboardingAbandoned: "circle_card_onboarding_abandoned",
  circleCardSourceCardReturned: "circle_card_source_card_returned",
  proPageViewed: "pro_page_viewed",
  proCtaClicked: "pro_cta_clicked",
  proFeatureLockedViewed: "pro_feature_locked_viewed",
  studioPreviewStarted: "studio_preview_started",
  studioDraftSaved: "studio_draft_saved",
  studioUpgradeClicked: "studio_upgrade_clicked",
  checkoutRequested: "checkout_requested",
  checkoutReused: "checkout_reused",
  checkoutFailed: "checkout_failed",
  portalOpened: "portal_opened",
  authoritativeProConfirmed: "authoritative_pro_confirmed",
