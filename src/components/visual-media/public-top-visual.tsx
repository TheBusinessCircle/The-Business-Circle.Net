...
export function PublicTopVisual({
  ...
  return (
    <section className={cn("w-full", className)}>
      <div className="hero-visual-shell relative min-h-[14rem] overflow-hidden rounded-[2.15rem] border border-border/70 bg-[radial-gradient(circle_at_top,rgba(82,146,255,0.18),transparent_32%),radial-gradient(circle_at_82%_18%,rgba(214,180,103,0.16),transparent_28%),linear-gradient(180deg,rgba(12,19,36,0.94),rgba(5,10,24,0.98))] shadow-[0_26px_70px_rgba(2,6,23,0.24)] sm:min-h-[18rem] lg:min-h-[23rem] 2xl:min-h-[26rem]">
