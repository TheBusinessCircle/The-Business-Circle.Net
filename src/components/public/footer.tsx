...
export async function Footer() {
  ...
  return (
    <footer className="border-t border-border/80 bg-background/92">
      <div className="mx-auto grid w-full max-w-[1400px] gap-8 px-5 py-12 sm:px-6 lg:grid-cols-[1.25fr_0.8fr_0.8fr_0.9fr] lg:px-8 lg:py-16">
      ...
      <div className="border-t border-border/80">
        <div className="mx-auto flex w-full max-w-[1400px] flex-col gap-2 px-5 py-5 text-xs text-muted sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
