      ...
      <details data-circle-card-module-details className="group">
        ...
        <div className="border-t border-silver/12 p-3 sm:p-4">
          ...
          <div className="mt-4 grid gap-2">
            ...
            {!items.length ? <p className="rounded-xl border border-dashed border-silver/18 bg-background/18 p-3 text-sm text-muted">Give visitors clear starting points before they enquire.</p> : null}
          </div>
