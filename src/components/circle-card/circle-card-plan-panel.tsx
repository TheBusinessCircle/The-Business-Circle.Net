        ...
        <div className="grid gap-4 lg:grid-cols-2">
          <div className="rounded-2xl border border-silver/14 bg-background/20 p-4">
            <div className="flex items-start justify-between gap-3">
              <div>
                <p className="text-[11px] uppercase tracking-[0.08em] text-gold">Upgrade preview</p>
                <h3 className="mt-1 text-lg font-semibold text-foreground">{proPlan.shortLabel}</h3>
                <p className="mt-1 text-xs leading-relaxed text-muted">{proPlan.description}</p>
              </div>
          ...
          <div className="rounded-2xl border border-silver/14 bg-background/20 p-4">
            <div className="flex items-start justify-between gap-3">
              <div>
                ...
                <h3 className="mt-1 text-lg font-semibold text-foreground">{teamsPlan.shortLabel}</h3>
                <p className="mt-1 text-xs leading-relaxed text-muted">{teamsPlan.description}</p>
              </div>
              <span className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-silver/18 bg-silver/10 text-silver">
                <UsersRound size={17} />
              </span>
            </div>
            <div className="mt-4">
              <FeaturePreviewList features={CIRCLE_CARD_TEAMS_FEATURE_PREVIEWS} />
            </div>
            <Button type="button" variant="outline" disabled className="mt-4 w-full gap-2">
              <Lock size={15} />
              {teamsPlan.upgradeMessaging.actionLabel}
            </Button>
          </div>
        </div>
      </div>
