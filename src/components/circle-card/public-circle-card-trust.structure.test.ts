...
describe("public Circle Card trust journey", () => {
  it("renders honest trust score content and both public testimonial entry points", () => {
    ...
    expect(profile).toContain("Save this Circle Card to your wallet before leaving a testimonial.");
  ...
  it("preserves the public target in the wallet-only dashboard combobox", () => {
    ...
    expect(walletForm).toContain("You already have a testimonial awaiting approval for this card.");
  });
