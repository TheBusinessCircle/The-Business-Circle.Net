...
export function assertBuildWorkspaceInputs(root: string, phase: "fresh" | "post-install" | "post-build", gitRunner?: (root: string, arguments_: string[], encoding?: BufferEncoding | "buffer") => string | Buffer): { ignoredCount: number; allowedPrefixes: string[] };
