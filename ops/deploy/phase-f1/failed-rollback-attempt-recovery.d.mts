...
export const RECOVERY_PLAN_SCHEMA: "phase-f1-failed-rollback-attempt-recovery-plan-v2";
export const RECOVERY_REPORT_SCHEMA: "phase-f1-failed-rollback-attempt-recovery-report-v2";
export const EMPTY_FIXTURE_RESIDUE: "EMPTY";
export const NONEMPTY_PARTIAL_FIXTURE_RESIDUE: "NONEMPTY_PARTIAL_BUILD";
export function inspectFailedFixtureResidue(path: string, options?: Record<string, unknown>): Record<string, unknown>;
